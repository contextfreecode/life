...
var ASM_CONSTS = {
  124344: () => { if (document.fullscreenElement) return 1; },  
 124390: () => { return document.getElementById('canvas').width; },  
 124442: () => { return parseInt(document.getElementById('canvas').style.width); },  
 124510: () => { document.exitFullscreen(); },  
 124537: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 124610: () => { if (document.fullscreenElement) return 1; },  
 124656: () => { return document.getElementById('canvas').width; },  
 124708: () => { return screen.width; },  
 124733: () => { document.exitFullscreen(); },  
 124760: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 124893: () => { return window.innerWidth; },  
 124919: () => { return window.innerHeight; },  
 124946: () => { if (document.fullscreenElement) return 1; },  
 124992: () => { return document.getElementById('canvas').width; },  
 125044: () => { return parseInt(document.getElementById('canvas').style.width); },  
 125112: () => { if (document.fullscreenElement) return 1; },  
 125158: () => { return document.getElementById('canvas').width; },  
 125210: () => { return screen.width; },  
 125235: () => { return window.innerWidth; },  
 125261: () => { return window.innerHeight; },  
 125288: () => { if (document.fullscreenElement) return 1; },  
 125334: () => { return document.getElementById('canvas').width; },  
 125386: () => { return screen.width; },  
 125411: () => { document.exitFullscreen(); },  
 125438: () => { if (document.fullscreenElement) return 1; },  
 125484: () => { return document.getElementById('canvas').width; },  
 125536: () => { return parseInt(document.getElementById('canvas').style.width); },  
 125604: () => { document.exitFullscreen(); },  
 125631: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 125689: () => { return screen.width; },  
 125714: () => { return screen.height; },  
 125740: () => { return window.screenX; },  
 125767: () => { return window.screenY; },  
 125794: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 125847: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 125918: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 125975: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 126231: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 126302: () => { if (document.fullscreenElement) return 1; },  
 126348: () => { return window.innerWidth; },  
 126374: () => { return window.innerHeight; },  
 126401: () => { if (document.pointerLockElement) return 1; }
};
